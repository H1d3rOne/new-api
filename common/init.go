...
func initConstantEnv() {
	...
	TrafficLogEnabled = GetEnvOrDefaultBool("TRAFFIC_LOG_ENABLED", true)
	TrafficLogMaxBodyBytes = GetEnvOrDefault("TRAFFIC_LOG_MAX_BODY_BYTES", 64*1024)
	TrafficInterceptEnabled = GetEnvOrDefaultBool("TRAFFIC_INTERCEPT_ENABLED", false)
