...
func InitOptionMap() {
	...
	common.OptionMap["TrafficInterceptEnabled"] = strconv.FormatBool(common.TrafficInterceptEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "TrafficInterceptEnabled":
			common.TrafficInterceptEnabled = boolValue
